...
void loop() {
  ...
  ch4_value = pulseIn(CH4_PIN, HIGH);   // channel 3: motor
  Serial.print("Channel 4 value is: ");
  Serial.println(ch4_value);
  delay(20);

  // steering
  angle = map(ch1_value, 1000, 2020, 30, 149);
  Serial.print("The angle is: ");
  Serial.println(angle);
  myServo.write(angle);

  // motor drive and speed
  speedmultiplier = (map(ch4_value, 1000, 2020, 0, 100)) / 100;
  ...
  if (speedy > 135 && speedy < 256)   // forward
  {
    ...
    motor1->setSpeed(speedindir * speedmultiplier); 
    motor2->setSpeed(speedindir * speedmultiplier);
    delay(20);
  }
