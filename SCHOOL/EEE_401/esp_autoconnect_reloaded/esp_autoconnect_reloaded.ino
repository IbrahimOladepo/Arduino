...
String apiKey = "FAGT3WUKJJR4FOCI";
...
char hi_temp[5];
char lo_temp[5];
String GET = "GET /update?key=FAGT3WUKJJR4FOCI";
...
void loop() {
  ...
  String state1 = String(distanceCm);
...
void updateTS( String T)
{
  ...
  if( Serial.find("OK") )
  {
    esper.println( "RECEIVED: OK" );
  }
  else
  {
    esper.println( "RECEIVED: Error\nExit2" );
  }
}
